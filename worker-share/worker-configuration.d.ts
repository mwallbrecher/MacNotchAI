/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a67d9dff1fee73c30c172df5168b000f)
// Runtime types generated with workerd@1.20260801.1 2026-08-06 nodejs_compat
interface __BaseEnv_Env {
	PAYLOADS: R2Bucket;
	DB: D1Database;
	CREATE_BURST: RateLimit;
	CLAIM_BURST: RateLimit;
	PAYLOAD_BURST: RateLimit;
	OWNER_BURST: RateLimit;
	VERIFIER_HMAC_SECRET: string;
	KEY_WRAP_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VERIFIER_HMAC_SECRET" | "KEY_WRAP_SECRET">> {}
}
